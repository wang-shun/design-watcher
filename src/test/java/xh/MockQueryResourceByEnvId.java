...
@WebAppConfiguration
public class MockQueryResourceByEnvId {
    ...
    public void testQuery() throws Exception {
        QueryCPUMEMParameter param = new QueryCPUMEMParameter();
        param.setApplicationRuntimeId(1);
        param.setApplicationProjectId(33);

        String param_json = JSONObject.toJSONString(param);
        System.out.println(param_json);
        mockMvc.perform(post("/v1.6/getCPUMEMCount.do")
