...
@WebAppConfiguration
public class MockQueryTotalResourceByApplicationId {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        queryEnvIdParameter.setApplicationId(175);
        queryEnvIdParameter.setResourceType("queryResourceByApplicationId");
