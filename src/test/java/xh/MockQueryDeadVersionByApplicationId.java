...
@WebAppConfiguration
public class MockQueryDeadVersionByApplicationId {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        queryEnvIdParameter.setApplicationId(123);
        queryEnvIdParameter.setResourceType("queryDeadVersionByApplicationId");
