...
@WebAppConfiguration
public class MockQueryNetworkPolicyByNetworkNameList {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        //queryEnvIdParameter.setEnvId(0);
        //queryEnvIdParameter.setNetworkName("18");
        List<String> networkNameList = new ArrayList<>();
        //networkNameList.add("network4");
        networkNameList.add("network3");


        queryEnvIdParameter.setNetworkNameList(networkNameList);
        queryEnvIdParameter.setEnvId(4);
        queryEnvIdParameter.setResourceType("queryNetworkPolicyByNetworkNameList");
