...
@WebAppConfiguration
public class MockQueryContainerDetail {
    ...
    @Test
    public void getContainerName() throws Exception {
       //开始构建 QueryParameter
        QueryEnvIdParameter queryEnvIdParameter = new QueryEnvIdParameter();
        queryEnvIdParameter.setContainerId(468);
        queryEnvIdParameter.setResourceType("queryOneContainerDetailById");
        ...
        mockMvc.perform(post("/v1.6/queryResource.do").contentType(MediaType.APPLICATION_JSON)
                .content(param_json)).andDo(print()).andReturn();
