...
@WebAppConfiguration
public class MockQueryNetworkPolicyDetailByNetworkPolicyId {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        queryEnvIdParameter.setEnvId(11);
        queryEnvIdParameter.setNetworkPolicyId(72);
        queryEnvIdParameter.setResourceType("queryNetworkPolicyDetailByNetworkPolicyId");
