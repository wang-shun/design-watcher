...
@WebAppConfiguration
public class MockShrinkDeployment {
    ...
    public void createRawApplication() throws Exception {
        //开始构建 QueryParameter
        ImageGroupParameter igp = new ImageGroupParameter();
        igp.setPlatfromType("kubernetes-deployment");
        igp.setCurrentVersionId(134);
        igp.setShrinkageNumber(3);
        igp.setExpansionNumber(3);
        //igp.setDeployType("expanseDeployment");
        igp.setDeployType("shrinkDeployment");

        System.out.println(JSONObject.toJSONString(igp));

        String param_json = JSONObject.toJSONString(igp);
