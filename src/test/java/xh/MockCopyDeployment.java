...
@WebAppConfiguration
public class MockCopyDeployment {
    ...
    public void createRawApplication() throws Exception {
        ...
        parameter.setReplica(2);
        //创建 deploy type
        String deployType = "copyDeployment";
        ...
        imageGroup.setMasterIp("192.168.2.160");
        imageGroup.setMasterPort("8080");
        imageGroup.setMasterType("http");
        imageGroup.setImageGroupName("deployment-test-xh");
        ...
        for (MockCreateDeployment.LabelType labelType: MockCreateDeployment.LabelType.values()) {
