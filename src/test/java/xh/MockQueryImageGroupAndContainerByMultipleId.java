...
@WebAppConfiguration
public class MockQueryImageGroupAndContainerByMultipleId {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        //queryEnvIdParameter.setEnvId(1);
        //queryEnvIdParameter.setProjectId(33);
        queryEnvIdParameter.setApplicationId(10001);
        //queryEnvIdParameter.setVersionId(152);
        queryEnvIdParameter.setNum_per_page(1);
        queryEnvIdParameter.setPageNum(1);
        queryEnvIdParameter.setResourceType("queryImageGroupAndContainersByMultipleId");
