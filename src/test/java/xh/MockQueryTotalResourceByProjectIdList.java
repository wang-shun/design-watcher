...
@WebAppConfiguration
public class MockQueryTotalResourceByProjectIdList {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        projectList.add(32);
        queryEnvIdParameter.setProjectIdList(projectList);
        queryEnvIdParameter.setResourceType("queryResourceByProjectIdList");
