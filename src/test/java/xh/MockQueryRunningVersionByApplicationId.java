...
@WebAppConfiguration
public class MockQueryRunningVersionByApplicationId {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        queryEnvIdParameter.setApplicationId(113);
        queryEnvIdParameter.setResourceType("queryRunningVersionByApplicationId");
