...
@WebAppConfiguration
public class MockQueryRunningDeploymentCountByVersionId {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        queryEnvIdParameter.setVersionId(50000038);
        queryEnvIdParameter.setResourceType("queryRunningDeploymentCountByVersionId");
