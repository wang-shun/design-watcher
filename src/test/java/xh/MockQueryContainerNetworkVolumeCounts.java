...
@WebAppConfiguration
public class MockQueryContainerNetworkVolumeCounts {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        queryEnvIdParameter.setProjectIds("42,45");
        queryEnvIdParameter.setResourceType("queryContainerNetworkVolumeCounts");
