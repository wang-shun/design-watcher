...
@WebAppConfiguration
public class MockQueryRunningInstanceByApplicationId {
    ...
    public void createRawApplication() throws Exception {
       //开始构建 QueryParameter
        ...
        queryEnvIdParameter.setApplicationId(10043);
        queryEnvIdParameter.setResourceType("queryRunningInstanceByApplicationId");
