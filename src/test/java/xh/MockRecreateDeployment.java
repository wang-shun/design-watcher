...
@WebAppConfiguration
public class MockRecreateDeployment {
    ...
    public void createRawApplication() throws Exception {
        ...
        image.setImageName("redis");
        image.setImageTag("latest");
        image.setId(0);
